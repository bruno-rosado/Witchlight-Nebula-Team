...
const EONET_JSON_PATH = process.env.EONET_JSON_PATH ?? path.join(__dirname, "eonet-events.json");
export function register(server) {
    server.registerResource("eonet-events", new ResourceTemplate("eonet://events", {
