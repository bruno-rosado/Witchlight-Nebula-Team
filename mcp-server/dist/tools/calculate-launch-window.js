...
export function register(server) {
    server.registerTool("calculate-launch-window", {
        ...
        try {
            ...
            const nearbyEvents = (eonetData.events || []).filter((event) => {
